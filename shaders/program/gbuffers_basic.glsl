...
#if (defined CLOUD_SHADOW && defined OVERWORLD) || defined COLORED_LIGHTING
...
void main(){
	...
	if (albedocheck > 0.00001){	
		...
		GetLighting(albedo.rgb, shadow, viewPos, lViewPos, worldPos, lightmap, 1.0, NdotL, quarterNdotU,
