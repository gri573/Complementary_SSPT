		...
		if (albedo.a > 0.0) {
			...
			float metalness = 0.0;
				...
				if (normalMap == vec3(0.0)) {
					...
					if (underWater        > 0.5) albedo.rgb = rawWaterColor.rgb * rawWaterColor.a * 2.5, albedo.a = 0.01;
			...
			GetLighting(albedo.rgb, shadow, viewPos, lViewPos, worldPos, lightmap, 1.0, NdotL, 1.0,
